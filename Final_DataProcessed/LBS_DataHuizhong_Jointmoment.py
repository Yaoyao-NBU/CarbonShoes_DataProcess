...
def save_results(result, output_dir, stiffness):
    ...
    for col, df in result.items():
        if df.empty:
            ...
            continue
        save_path = os.path.join(output_dir, f'ID_{col}.csv')
...
if __name__ == '__main__':
    ...
    for runner_type in RUNNER_TYPES:
        ...
        for stiffness in STIFFNESS_LIST:
            ...
            current_output_dir = os.path.join(BASE_OUTPUT_DIR, runner_type, stiffness, 'Joint_moment')
