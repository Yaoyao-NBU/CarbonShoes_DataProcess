...
# 1. 设置配置 (请在这里指定您的单个文件)
# ==========================================
TARGET_FILE = r'G:\Carbon_Plate_Shoes_Data\Carbon_Fiber_Shoes_DataProcessed\Speed_Spilt\High_Speed\Summary_Statistics_UnInterpolte\Load_Joint_angle/Summary_IK_knee_angle_r.csv'
OUTPUT_DIR = r'G:\Carbon_Plate_Shoes_Data\Carbon_Fiber_Shoes_DataProcessed\Speed_Spilt\High_Speed\Summary_Statistics_UnInterpolte\Load_Joint_angle/Single_File_Stats_Result'

# 🎯 自定义您的图表 Y 轴标签
Y_AXIS_LABEL = 'IC Knee Angle (°)'
